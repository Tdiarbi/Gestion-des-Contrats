...
Partial Public Class loginformDataSet4
    ...
    Partial Public Class Table_ContratDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddTable_ContratRow(ByVal Date_Signature As Date) As Table_ContratRow
            Dim rowTable_ContratRow As Table_ContratRow = CType(Me.NewRow,Table_ContratRow)
            Dim columnValuesArray() As Object = New Object() {Date_Signature}
...
Namespace loginformDataSet4TableAdapters
    ...
    Partial Public Class Table_ContratTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table_Contrat] ([Date_Signature]) VALUES (@Date_Signature)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Date_Signature FROM dbo.Table_Contrat"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As loginformDataSet4.Table_ContratDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As loginformDataSet4.Table_ContratDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As loginformDataSet4.Table_ContratDataTable = New loginformDataSet4.Table_ContratDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As loginformDataSet4.Table_ContratDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Date_Signature As Global.System.Nullable(Of Date)) As Integer
            If (Date_Signature.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = CType(Date_Signature.Value,Date)
            Else
